...
GARMENT_AMAZON_CATS: dict[str, set[str]] = {
    ...
    "trench_coat": {"Trench Coats", "Raincoats", "Coats"},
    "blazer":      {"Blazers", "Suit Jackets", "Suits & Blazers"},
    "parka":       {"Parkas", "Down Jackets", "Puffer Jackets"},
...
GARMENT_TITLE_KEYWORDS: dict[str, list[str]] = {
    ...
    "trench_coat": ["trench coat", "trenchcoat", "raincoat"],
    "blazer":      ["blazer", "suit jacket"],
    "parka":       ["parka", "down jacket", "puffer jacket", "puffer coat"],
