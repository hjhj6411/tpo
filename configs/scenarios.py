...
- casual_leisure: incompatible garments extended with 'formal_shirt'
  ...
  blazer+pea_coat still have a preference-neutral TPO-violating garment.
- extreme_heat / aquatic_water: 'puffer_jacket' and 'leather_jacket' added to
  incompatible garments (same physical rationale as fleece/pea_coat).
...
v12 (`wacv_scenario_v3`) — garment vocabulary expansion:
- Replace trench_coat with length-specific pea_coat / long_coat labels and add
  visually distinct suit_vest and polo_shirt labels.
- Review all 73 profile-generation scenarios against the expanded vocabulary;
...
CANONICAL_SCENARIOS = [{'scenario_id': 'cold_blizzard_outdoor',
  ...
  'garment_category': {'compatible': ['fleece_jacket', 'puffer_jacket', 'sweater', 'hoodie'],
                       'incompatible': ['shorts', 'tank_top', 't_shirt', 'polo_shirt', 'dress', 'mini_skirt']},
 ...
 {'scenario_id': 'heat_beach_day',
  ...
  'tpo': {'time': {'season': 'summer', 'weather': 'hot_humid'},
          ...
          'occasion': {'activity': 'casual_outing', 'formality_required': 'very_casual'}},
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'tank_top', 'shorts'],
                       'incompatible': ['fleece_jacket', 'puffer_jacket', 'leather_jacket', 'pea_coat',
                                        'sweater', 'blazer', 'suit_vest', 'long_coat']},
 ...
 {'scenario_id': 'water_swim_session',
  ...
  'tpo': {'place': {'venue': 'pool', 'indoor_outdoor': 'indoor'},
          'occasion': {'activity': 'exercise', 'formality_required': 'very_casual'}},
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'tank_top', 'shorts'],
                       'incompatible': ['pea_coat', 'blazer', 'suit_vest', 'long_coat', 'fleece_jacket', 'puffer_jacket',
 ...
 {'scenario_id': 'gym_weight_training',
  ...
  'tpo': {'place': {'venue': 'gym', 'indoor_outdoor': 'indoor'},
          'occasion': {'activity': 'exercise', 'formality_required': 'very_casual'}},
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt',
                                      'tank_top',
                                      'shorts',
                                      'hoodie',
                                      'sweater',
                                      'leggings'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'pea_coat', 'dress', 'fleece_jacket', 'formal_shirt']},
 ...
 {'scenario_id': 'field_road_run',
  ...
  'tpo': {'place': {'indoor_outdoor': 'outdoor'},
          'occasion': {'activity': 'exercise', 'formality_required': 'very_casual'}},
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'tank_top', 'shorts', 'windbreaker', 'hoodie'],
                       'incompatible': ['pea_coat', 'blazer', 'suit_vest', 'long_coat', 'dress', 'fleece_jacket', 'formal_shirt']},
 ...
 {'scenario_id': 'rugged_mountain_hike',
  ...
  'garment_category': {'compatible': ['windbreaker',
                                      ...
                                      'sweater',
                                      'fleece_jacket'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'dress', 'long_skirt', 'formal_shirt', 'slacks']},
 ...
 {'scenario_id': 'weather_freezing_rain',
  ...
  'garment_category': {'compatible': ['windbreaker', 'puffer_jacket', 'fleece_jacket'],
                       'incompatible': ['dress', 'tank_top', 'shorts', 'mini_skirt', 't_shirt', 'polo_shirt']},
 ...
 {'scenario_id': 'casual_park_picnic',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt',
                                      ...
                                      'cardigan',
                                      'sweatshirt'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'pea_coat', 'formal_shirt']},
  'justification': 'A suit jacket/blazer/pea coat or a pressed dress shirt at a casual park '
 ...
 {'scenario_id': 'casual_amusement_park',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt',
                                      ...
                                      'cardigan',
                                      'sweatshirt'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'pea_coat', 'formal_shirt', 'slacks']},
 ...
 {'scenario_id': 'work_moving_day',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'sweatshirt', 'hoodie', 'jeans', 'shorts'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'pea_coat', 'formal_shirt', 'slacks',
 ...
 {'scenario_id': 'biz_corporate_board',
  ...
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'formal_shirt',
                                      'slacks', 'dress', 'long_skirt'],
 ...
 {'scenario_id': 'biz_client_meeting',
  ...
  'tpo': {'time': {'time_of_day': 'evening'},
          ...
          'occasion': {'activity': 'work_meeting', 'formality_required': 'business_casual'}},
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'polo_shirt',
                                      'slacks', 'dress', 'long_skirt'],
 ...
 {'scenario_id': 'formal_black_tie_gala',
  ...
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'dress', 'formal_shirt', 'slacks', 'long_skirt'],
                       'incompatible': ['hoodie', 'shorts', 'tank_top', 't_shirt', 'polo_shirt']},
  ...
  'color': {'compatible': ['black', 'navy', 'gray', 'white'],
            ...
            'violation_garment_scope': ['blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'slacks']},
 ...
 {'scenario_id': 'formal_national_award',
  ...
  'tpo': {'time': {'time_of_day': 'evening'},
          'place': {'indoor_outdoor': 'indoor'},
          'occasion': {'activity': 'ceremony_attendance', 'formality_required': 'formal'}},
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'dress', 'formal_shirt'],
                       'incompatible': ['hoodie', 'shorts', 'tank_top', 't_shirt', 'polo_shirt']},
 ...
 {'scenario_id': 'civic_supreme_argument',
  ...
  'tpo': {'time': {'time_of_day': 'daytime'},
          'place': {'indoor_outdoor': 'indoor'},
          'occasion': {'formality_required': 'formal'}},
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'slacks', 'dress'],
                       'incompatible': ['hoodie', 'shorts', 'tank_top', 't_shirt', 'polo_shirt']},
 ...
 {'scenario_id': 'mourn_funeral',
  ...
  'tpo': {'place': {'indoor_outdoor': 'mixed'},
          'occasion': {'activity': 'ceremony_attendance', 'formality_required': 'formal'}},
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'pea_coat', 'formal_shirt', 'dress', 'sweater', 'slacks', 'long_skirt'],
                       'incompatible': ['shorts', 'tank_top', 'hoodie', 't_shirt', 'polo_shirt']},
 ...
 {'scenario_id': 'mourn_vigil',
  ...
  'garment_category': {'compatible': ['pea_coat', 'blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'sweater', 'dress'],
                       'incompatible': ['shorts', 'tank_top', 't_shirt', 'polo_shirt']},
 ...
 {'scenario_id': 'mourn_condolence_visit',
  ...
  'tpo': {'place': {'indoor_outdoor': 'indoor'},
          'occasion': {'activity': 'ceremony_attendance', 'formality_required': 'smart_casual'}},
  'garment_category': {'compatible': ['formal_shirt', 'blazer', 'suit_vest', 'long_coat', 'sweater', 'pea_coat', 'dress'],
                       'incompatible': ['shorts', 'tank_top', 'hoodie', 't_shirt', 'polo_shirt']},
 ...
 {'scenario_id': 'relig_conservative_worship',
  ...
  'garment_category': {'compatible': ['formal_shirt', 'blazer', 'suit_vest', 'long_coat', 'dress', 'sweater', 'pea_coat', 'long_skirt', 'cardigan', 'slacks'],
                       'incompatible': ['tank_top', 'shorts', 't_shirt', 'polo_shirt', 'hoodie']},
 ...
 {'scenario_id': 'social_gallery_opening',
  ...
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'dress',
                                      'long_skirt', 'slacks', 'sweater', 'cardigan'],
 ...
 {'scenario_id': 'social_first_date_upscale',
  ...
  'garment_category': {'compatible': ['formal_shirt', 'blazer', 'suit_vest', 'long_coat', 'dress',
                                      'long_skirt', 'slacks', 'sweater', 'cardigan'],
                       'incompatible': ['hoodie', 'shorts', 'tank_top']},
 ...
 {'scenario_id': 'wedding_garden_ceremony',
  ...
  'tpo': {'time': {'season': 'spring', 'weather': 'sunny'},
          ...
          'occasion': {'activity': 'ceremony_attendance', 'formality_required': 'smart_casual'}},
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'dress', 'formal_shirt', 'long_skirt'],
                       'incompatible': ['hoodie', 'shorts', 'tank_top', 't_shirt', 'polo_shirt']},
 ...
 {'scenario_id': 'visib_night_road_run',
  ...
  'garment_category': {'compatible': ['windbreaker', 't_shirt', 'polo_shirt', 'sweatshirt', 'leggings', 'shorts'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'pea_coat', 'slacks', 'dress', 'long_skirt']},
 ...
 {'scenario_id': 'visib_night_bike_commute',
  ...
  'garment_category': {'compatible': ['windbreaker', 't_shirt', 'polo_shirt', 'sweatshirt', 'leggings'],
                       'incompatible': ['pea_coat', 'long_skirt', 'dress', 'blazer', 'suit_vest', 'long_coat']},
 ...
 {'scenario_id': 'visib_dawn_roadside_cleanup',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'sweatshirt', 'windbreaker', 'jeans', 'leggings'],
                       'incompatible': ['dress', 'blazer', 'suit_vest', 'long_coat', 'slacks', 'pea_coat']},
 ...
 {'scenario_id': 'field_safari_tour',
  ...
  'garment_category': {'compatible': ['formal_shirt', 't_shirt', 'polo_shirt', 'windbreaker', 'jeans', 'shorts'],
                       'incompatible': ['dress', 'mini_skirt', 'blazer', 'suit_vest', 'long_coat', 'leather_jacket']},
 ...
 {'scenario_id': 'field_wildlife_hide',
  ...
  'garment_category': {'compatible': ['sweatshirt', 'hoodie', 'windbreaker', 'fleece_jacket', 'jeans'],
                       'incompatible': ['dress', 'blazer', 'suit_vest', 'long_coat', 'mini_skirt', 'pea_coat']},
 ...
 {'scenario_id': 'stage_backstage_crew',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'sweatshirt', 'hoodie', 'jeans', 'slacks'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'dress', 'pea_coat', 'mini_skirt']},
 ...
 {'scenario_id': 'stage_greenscreen_shoot',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'sweatshirt', 'sweater', 'jeans', 'leggings'],
                       'incompatible': ['pea_coat', 'windbreaker']},
 ...
 {'scenario_id': 'stage_tv_interview',
  ...
  'garment_category': {'compatible': ['blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'dress', 'slacks', 'long_skirt'],
                       'incompatible': ['hoodie', 'tank_top', 't_shirt', 'polo_shirt', 'shorts']},
 ...
 {'scenario_id': 'club_tennis_whites',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'shorts', 'mini_skirt'],
                       'incompatible': ['jeans', 'leather_jacket', 'pea_coat', 'slacks',
                                        'blazer', 'suit_vest', 'long_coat', 'hoodie']},
 ...
 {'scenario_id': 'club_yacht_regatta',
  ...
  'garment_category': {'compatible': ['formal_shirt', 'windbreaker', 'slacks', 'shorts', 't_shirt', 'polo_shirt', 'sweater'],
 ...
 {'scenario_id': 'club_golf_round',
  ...
  'garment_category': {'compatible': ['formal_shirt', 'polo_shirt', 'sweater', 'slacks',
                                      'mini_skirt', 'shorts'],
 ...
 {'scenario_id': 'festive_holiday_party',
  ...
  'garment_category': {'compatible': ['dress', 'blazer', 'suit_vest', 'long_coat', 'formal_shirt', 'long_skirt', 'mini_skirt'],
 ...
 {'scenario_id': 'garden_spring_party',
  ...
  'garment_category': {'compatible': ['dress', 'blazer', 'suit_vest', 'long_coat', 'formal_shirt',
                                      'polo_shirt', 'long_skirt', 'cardigan'],
                       'incompatible': ['hoodie', 'sweatshirt', 'tank_top', 'shorts']},
 ...
 {'scenario_id': 'sports_home_game',
  ...
  'garment_category': {'compatible': ['t_shirt', 'polo_shirt', 'tank_top', 'sweatshirt', 'hoodie', 'sweater',
                                      'cardigan', 'jeans', 'shorts', 'leggings', 'windbreaker',
                                      'leather_jacket', 'puffer_jacket', 'mini_skirt'],
                       'incompatible': ['blazer', 'suit_vest', 'long_coat', 'dress', 'slacks', 'pea_coat',
...
for _sc in CANONICAL_SCENARIOS:
    _garment_constraint = _sc["garment_category"]
    _garment_compatible = set(_garment_constraint["compatible"])
    _garment_incompatible = set(_garment_constraint["incompatible"])
    _garment_vocab = set(FASHION_ATTRIBUTE_AXES["garment_category"])
    assert not (_garment_compatible & _garment_incompatible), (
        f"garment constraint overlap: {_sc['scenario_id']}")
    assert (_garment_compatible | _garment_incompatible) <= _garment_vocab, (
        f"garment vocabulary drift: {_sc['scenario_id']} has "
        f"{sorted((_garment_compatible | _garment_incompatible) - _garment_vocab)}")
...
_profile_catalog_garments = {
    garment
    for scenario in PROFILE_GENERATION_SCENARIOS
    for side in ("compatible", "incompatible")
    for garment in scenario["garment_category"][side]
}
assert set(FASHION_ATTRIBUTE_AXES["garment_category"]) <= _profile_catalog_garments, (
    "profile scenario catalog does not cover the full garment vocabulary: "
    f"{sorted(set(FASHION_ATTRIBUTE_AXES['garment_category']) - _profile_catalog_garments)}")
